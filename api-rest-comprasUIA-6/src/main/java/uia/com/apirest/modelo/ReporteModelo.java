...
public class ReporteModelo extends ItemComprasUIAModelo{
    ...
    private ArrayList<ItemComprasUIAModelo> items = new ArrayList<ItemComprasUIAModelo>();
    ...
    public ArrayList<ItemComprasUIAModelo> getItems() {
        return items;
    }

    public void setItems(ArrayList<ItemComprasUIAModelo> misItemsSolicitudesOC) {
        this.items = misItemsSolicitudesOC;
    }
